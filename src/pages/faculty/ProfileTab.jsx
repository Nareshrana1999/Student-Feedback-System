        ...
        <Card className="dashboard-card">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input id="subject" value={profileData.subject || ''} onChange={(e) => setProfileData({ ...profileData, subject: e.target.value })} disabled={!isEditing} className="bg-white/5 border-white/20 text-white disabled:opacity-60" />
            </div>
            <div>
              <Label htmlFor="role">Role</Label>
              <Input id="role" value="Faculty Member" disabled className="bg-white/5 border-white/20 text-white opacity-60" />
            </div>
          </CardContent>
        </Card>
      </div>
